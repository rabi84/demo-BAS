sap.ui.define([
	...
	return BaseController.extend("copyinspectionlot.controller.List", {
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "copyinspectionlot.view.ViewSettingsDialog",
					controller: this
		...
		_showDetail: function (oItem) {
            ...
            var product = oItem.getBindingContext("products").getPath().split("/")[2];
			// set the layout property of FCL control to show two columns
			this.getModel("appView").setProperty("/layout", "TwoColumnsMidExpanded");
			this.getRouter().navTo("object", {
				// objectId : oItem.getBindingContext().getProperty("products")
				objectId : product
			}, bReplace);
		},
